...
from doc.models import ActorArea, CUBE_DocumentJsonList, DocumentActor, JudgmentJudge, JudgmentSearchParameters, \
...
from doc.models import ActorArea, CUBE_DocumentJsonList, DocumentActor, Rahbari, StandardGraphType, JudgmentJudge, JudgmentSearchParameters, JudgmentSubjectTypeDisplayName, JudgmentType, LegalOrientation, SimilarityType, Standard, Standard_Branch, Standard_Status, StandardSearchParameters, Type, KeywordList, Subject, SubjectKeyWords, Slogan , SloganSynonymousWords
