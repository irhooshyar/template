function showTour(){
    ...
    steps: [{
        ...
        intro: "در این پنل با انتخاب کشور و موضوع خبر، می‌توانید به تحلیل مراجع رسمی بپردازید."
    }, {
        ...
        intro: "در این تب می‌توانید لیست اسناد یافت‌شده را به همراه موضوع خبر و مرجع رسمی به‌کار رفته در آن، مشاهده نمایید."
    },{
