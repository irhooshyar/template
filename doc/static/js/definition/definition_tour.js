function showTour(){
    ...
    steps: [{
        ...
        intro: "در این پنل با انتخاب کشور و موضوع خبر می‌توانید کلیدواژگان و تعاریف آن‌ها در اسناد مختلف را مشاهده نمایید."
    }, {
        ...
        intro: "در این تب می‌توانید تعداد اسناد حاوی هر کلیدواژه را بر روی نمودار مشاهده نمایید. با کلیک بر روی هر ستون نمودار می‌توانید تعریف آن کلید واژه را به تفکیک خبر مشاهده نمایید."
    }, {
        element: document.querySelector('#keywords_graph_tab'),
        intro: "در این تب می‌توانید گراف واژگان را برای هر خبر مشاهده نمایید. با کلیک بر روی هر یال تعریف کلید واژه قابل مشاهده است."
    }, {
